 ...
 */
  ...
  [_LS] = LAYOUT_ortho_5x15(
    _______, DM_PLY1, DM_PLY2, _______, _______, _______, _______, KC_MUTE, _______, _______, _______, _______, _______, TD(TDAR), KC_PLUS,
    _______, _______, _______, _______, _______, KC_TURT, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   _______, _______,  KC_EQL,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   _______, _______,  _______,
    _______, C(KC_Y), _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, _______,  _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_P0,   _______, KC_PDOT, _______, _______,  _______
  ),
