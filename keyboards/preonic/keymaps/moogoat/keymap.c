 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CTRL | GUI  |Numpad| ALT  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid( \
  _______, _______, _______,   _______, _______,  _______, _______, _______, _______, KC_MINS, KC_EQL, KC_BSPC, \
  _______, _______, _______,   _______, _______,  _______, _______, KC_HOME, KC_UP, KC_END, _______, KC_DEL,  \
  _______, _______, _______,   _______, _______,  _______, C(KC_LEFT), KC_LEFT, KC_DOWN, KC_RIGHT, C(KC_RIGHT), _______, \
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |NUMPAD|      |      |      NUM_0  |NUM0  | NUM_0| NUM_.|NUMENT|      |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMPAD] = LAYOUT_preonic_grid( \
  _______, _______, _______, _______, _______, _______, _______, KC_CALC, KC_PSLS, KC_PAST, KC_PMNS, _______, \
  ...
  _______, _______, NUMPAD, _______, _______, KC_KP_0, KC_KP_0, KC_KP_0, KC_KP_0, KC_PDOT, KC_PENT, _______  \
)
